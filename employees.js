...
//CODE HERE
let empOne = Employee("Jess", "weekday mornings");
...
class Employee {
    constructor(name,jobTitle, baseSalary )
    { this.name = name;
...
class Manager extends Employee {
    Constructor(name, jobTitle, baseSalary, employees)
{
    super(name, jobTitle, baseSalary);
...
*/
const manager = new Manager ('Winston','Manager','200000',['Cece','Ola','Bob']);
